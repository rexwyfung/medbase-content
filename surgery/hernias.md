...
### Clinical Definition of Hernia
* **Hernia (疝氣)**: Abnormal protrusion of a viscus/part of a viscus through a defect in the wall of its containing cavity.
* **Reducible (可還納的)**: Contents can be pushed back into cavity.
* **Incarcerated/Irreducible (嵌頓)**: Contents cannot be returned → high risk of bowel obstruction.
* **Strangulated (絞窄)**: Blood supply to contents is compromised → ischaemia → necrosis → sepsis.

### Hong Kong Epidemiology & Demographics
* **Groin Hernias (腹股溝疝)**: 75% of all abdominal wall hernias.
* **Gender Ratio**: M:F ≈ 9:1 for inguinal; M:F ≈ 1:3 for femoral.
* **Lifetime Risk**: 27% in males, 3% in females.
* **HK Context**: Very common elective general surgery operation in **Hospital Authority (HA)** day surgery centers. Ageing HK population → ↑ incidence of direct hernias & complicated presentations in elderly.

## 2. Surgical Anatomy & Pathophysiology

### Anatomy of the Inguinal Canal (腹股溝管)
* **Length**: ~4cm oblique muscle-aponeurotic tunnel in adults.
* **Anterior Wall**: **External oblique aponeurosis (腹外斜肌腱膜)**, reinforced laterally by internal oblique.
* **Posterior Wall**: **Conjoint tendon (聯合腱)** medially, **Transversalis fascia (腹橫筋膜)** laterally.
* **Roof**: Arching fibers of **Internal oblique (腹內斜肌)** & transversus abdominis.
* **Floor**: **Inguinal ligament (腹股溝韌帶)**, reinforced medially by lacunar ligament.
* **Deep Inguinal Ring (深腹股溝環)**: Defect in transversalis fascia, midpoint of inguinal ligament.
...
* **Posterior**: **Pectineal ligament/Astley Cooper's ligament (恥骨梳韌帶)**.
* **Medial**: **Lacunar ligament (腔隙韌帶)**.
...
### Key Symptoms of Uncomplicated Hernia
* **Groin/Abdominal Bulge (腹股溝腫塊)**: ↑ on standing/coughing/straining, ↓ on lying down.
* **Discomfort/Dragging sensation**: Worsens at end of day or after physical exertion.

### Key Signs on Physical Examination
* **Inspection**: Visible lump with +ve **Cough impulse (咳嗽衝動)**.
* **Palpation**: Assess reducibility. If reducible, locate deep ring (1.5cm above mid-inguinal point) & apply pressure. If hernia is controlled by occlusion → Indirect; if bulges forward medial to finger → Direct.
* **Scrotal Examination**: Assess if lump extends above/below testicle. "Cannot get above the lump" → Inguino-scrotal hernia.

### Signs of Complicated Hernia (Incarcerated/Strangulated)
* **Incarcerated**: Irreducible lump, painful, firm.
* **Strangulated**: Exquisitely tender lump, overlying skin erythema/edema.
* **Bowel Obstruction (腸阻塞) Signs**: Nausea, bilious vomiting, colicky abdominal pain, absolute constipation, abdominal distension.
* **Systemic Toxicity**: Tachycardia, fever, ↑ WBC, ↑ Lactate.
...
### First-Line Investigations for Uncomplicated Hernia
* **Clinical Diagnosis**: Mostly relies on history & physical exam.
* **Blood Tests (Pre-op)**: CBP, LRFT, Coagulation profile, Group & Save (routine HA day-surgery workup).
* **ECG/CXR**: For patients >60 years or with significant cardiopulmonary comorbidities (HA protocol).

### Diagnostic Imaging for Occult/Complicated Hernias
* **USG Groin**: 1st line for ambiguous groin pain/swelling (Occult hernia). High sensitivity for cough-induced tissue displacement.
* **CT Abdomen & Pelvis (+/- contrast)**: Indicated for suspected incarceration/strangulation. Identifies transition point, bowel ischaemia (pneumatosis intestinalis, non-enhancing bowel wall), and exact fascial defect.
...
* **Incarcerated (non-toxic)**: Trial of manual reduction under analgesia/sedation in AED. If successful → semi-urgent list. If failed → emergency list.

## 7. Key Operative Principles & Consent Issues

### Principles of Open Mesh Repair (Lichtenstein Technique)
...
* **Specific (Groin)**: Ischaemic orchitis/testicular atrophy (rare but devastating), Chronic groin pain (post-herniorrhaphy neuralgia 5-10%), Recurrence (1-3%), Bladder/bowel injury (laparoscopic).

## 8. Post-operative Care (ERAS) & Rehabilitation

### Immediate Post-operative Care
* **Analgesia**: Paracetamol + NSAIDs + local anesthetic wound infiltration. Avoid opioids if possible to prevent constipation/PONV.
* **Diet & Mobilization**: Early oral feeding & mobilization within 4 hours (Day Surgery Protocol).
* **Scrotal Support**: Scrotal elevation/firm underwear to ↓ scrotal hematoma risk.
...
### Early Surgical Complications (<2 weeks)
* **Urinary Retention (尿瀦留)**: Most common early complication, esp. elderly males with BPH or after regional/spinal anesthesia.
* **Haematoma/Seroma**: Scrotal hematoma can be massive. Seromas often resolve spontaneously.
* **Wound Infection**: Prophylactic IV Ceftriaxone usually given at induction.

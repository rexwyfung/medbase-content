# Hip Fractures: Neck of Femur & Intertrochanteric (髖部骨折：股骨頸與轉子間骨折)
...
* **Classic Posture:** Shortened & externally rotated lower limb.
* **NOF vs IT Deformity:** ER deformity is more profound (up to 90°) in IT # because fracture is extracapsular (capsule restrains ER in NOF #).
* **Skin:** Bruising/ecchymosis over greater trochanter (late sign).

### Palpation & Movement (Feel, Move)
* **Feel:** Point tenderness over greater trochanter & femoral triangle (groin).
* **Move:** Pain severely exacerbates with attempted passive internal rotation or log roll.
* **Active Straight Leg Raise (SLR):** Usually unable to perform (except in impacted/undisplaced #).

### Neurovascular (NV) Assessment
...
### Standard X-ray Views for Hip Fractures
...
* **MRI Pelvis/Hip (T1/T2 STIR):** Gold standard. Identifies occult # or bone marrow edema.
* **CT Hip:** Alternative if MRI contraindicated/unavailable. Good for assessing pre-op comminution or complex fracture anatomy.
...
* **Geriatric Co-Management:** HK HA protocol emphasizes multidisciplinary care (Ortho + Geriatrics).
* **Investigations:** ECG, CXR (assess cardio-pulmonary fitness), CBC (Hb drop?), U&E (AKI/electrolytes), PT/APTT/INR, Group & Save (G&S).
* **Blood Management:** Transfuse if Hb <8 g/dL (or <9 g/dL with cardiac history). Reverse anticoagulants (e.g., Warfarin → Vitamin K / Prothrombin Complex Concentrate).

## 7. Definitive Management Algorithm

### HK HA Protocol Goal for Hip Fractures
* **Target:** Surgery within 48 hours of admission.
* **Aim:** Achieve stable fixation to allow immediate Weight Bearing As Tolerated (WBAT) to prevent complications of prolonged bed rest.
...
### Post-Operative Mobilization Guidelines
* **Day 1 Post-Op:** Physiotherapy (PT) assessment. Sit out of bed.
* **Weight Bearing:** Strictly **Weight Bearing As Tolerated (WBAT)** immediately for almost all elderly hip # fixations in HK (DHS, PFN, Hemi, THR) to prevent pneumonia/DVT.
* **Exception:** Non-weight bearing (NWB) or Toe-touch (TTWB) only if intra-operative concerns about fixation stability (e.g., severe osteoporosis, young patient ORIF NOF # to protect screws).
* **Hip Precautions (Post-Hemi/THR Posterior Approach):** Avoid hip flexion >90°, internal rotation, and adduction across midline for 6-12 weeks to prevent dislocation.

### Secondary Fall & Osteoporosis Prevention
* **Bone Health (骨質疏鬆治療):** DEXA scan post-op. Initiate Calcium/Vitamin D + Bisphosphonates (e.g., Alendronate) or Denosumab if indicated.
* **Occupational Therapy (OT):** Home assessment, grab bars, removal of loose rugs, prescription of walking aids (frame/stick).

## 9. Orthopaedic Complications

### Specific NOF Fracture Complications
* **Avascular Necrosis (AVN) (缺血性壞死):** Up to 30-40% in displaced NOF. Presents as late-onset groin pain.
* **Non-Union:** ↑ risk due to bathing in synovial fluid (inhibits fracture hematoma formation) and absent periosteal callus (neck has no periosteum).

### Specific Intertrochanteric Fracture Complications
...
* **Pneumonia / Atelectasis:** Requires incentive spirometry, early mobilization.
* **Urinary Tract Infection (UTI):** Remove urinary catheters ASAP.
* **Pressure Sores (Decubitus Ulcers):** Requires regular turning, air mattresses.

## 10. Examiner's Pearls

* Viva Question: What is the primary blood supply to the adult femoral head and why is it vulnerable? Answer: Medial circumflex femoral artery (MCFA). It runs intracapsularly along the femoral neck and is easily disrupted by displaced NOF fractures, leading to AVN.
* Viva Question: How do you clinically differentiate between a NOF fracture and an IT fracture on inspection? Answer: Both present with shortening and external rotation, but IT fractures have a much more profound external rotation deformity (often lying flat at 90° on the bed) because the fracture is extracapsular, whereas the intact hip capsule restricts rotation in a NOF fracture.
* Viva Question: What is Shenton's line? Answer: An imaginary continuous radiopaque arc formed by the inferior border of the superior pubic ramus and the medial cortex of the femoral neck. Disruption indicates a displaced hip fracture or hip dislocation.
* Trap: Assuming a patient who can perform an active Straight Leg Raise (SLR) does not have a hip fracture. Pearl: Patients with impacted, valgus-deformed, or undisplaced (Garden I/II) NOF fractures may still be able to perform an active SLR despite the fracture.
* Trap: Requesting a frog-leg lateral X-ray for a suspected acute hip fracture. Pearl: A frog-leg lateral requires abduction and external rotation, which can displace an undisplaced fracture and tear remaining retinacular vessels. Always request a cross-table lateral instead.
* Pitfall: Fixing a reverse oblique intertrochanteric fracture (Evans Type 2) with a Dynamic Hip Screw (DHS). The DHS relies on an intact lateral wall to provide a buttress for controlled sliding. In reverse oblique fractures, the lateral wall is compromised, leading to medialization of the shaft and fixation failure. Always use a cephalomedullary nail.
* Pitfall: Delaying elderly hip fracture surgery for exhaustive medical workup. Prolonged bed rest increases mortality exponentially. Optimize rapidly; the HK HA standard is surgery within 48 hours to allow immediate WBAT.
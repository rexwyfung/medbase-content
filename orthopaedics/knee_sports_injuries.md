# Knee Sports Injuries (膝關節運動創傷)

## 1. Clinical Definition, Mechanism of Injury (MOI) & Epidemiology

### Anterior Cruciate Ligament (ACL) Tears (前十字韌帶撕裂) Definition & MOI
...
* **Epidemiology:** Bimodal (young athletes = acute; elderly = degenerative).
* **MOI (Acute):** Twisting/rotational force on weight-bearing flexed knee.
* **MOI (Degenerative):** Minimal trauma (e.g., squatting) in older patients.


## 2. Applied Orthopaedic Anatomy & Biomechanics

### Cruciate Ligaments Biomechanics & Anatomy
* **ACL:** 
	* **Origin:** Posteromedial aspect of lateral femoral condyle.
	* **Insertion:** Anterior to intercondylar eminence of tibia.
	* **Bundles:** Anteromedial (AM) bundle (tight in flexion) & Posterolateral (PL) bundle (tight in extension).
	* **Function:** Prevents anterior tibial translation (85% of restraint) & internal rotation.
* **PCL:**
...
| :--- | :--- | :--- | :--- |
| **I** | Microscopic tear (Sprain) | < 5 mm (0-5mm) | Firm |
| **II** | Partial tear | 5 - 10 mm | Firm / Delayed |
| **III** | Complete rupture | > 10 mm | Soft / None |

### Meniscal Tear Morphological Classification
| Tear Type | Description | Classic Association |
| :--- | :--- | :--- |
| **Longitudinal** | Parallel to outer margin | Traumatic ACL injuries. Can progress to bucket-handle. |
| **Bucket-Handle** | Displaced longitudinal tear | Mechanical locking of knee. Requires urgent surgery. |
| **Radial** | Perpendicular to margin | Disrupts hoop stresses. Poor healing. |
| **Horizontal (Cleavage)** | Splits meniscus into top/bottom | Degenerative tears, associated with parameniscal cysts. |
...
### Acute ED Management of Knee Sprains and Tears
* **Protection & Immobilization:** Hinged knee brace or Zimmer splint (knee immobilizer) for pain relief and protection.
* **R.I.C.E.:** Rest, Ice, Compression (Tubigrip), Elevation.
* **Analgesia:** PO Paracetamol / NSAIDs (e.g., Ibuprofen, Arcoxia).
* **Weight Bearing:** Protected weight-bearing with crutches (PWB/NWB depending on pain and concurrent injuries).
* **Aspiration:** For extremely tense, painful hemarthrosis (under strict aseptic technique). Fat globules in aspirate (lipohaemarthrosis) = intra-articular #.

### ED Management of Locked Knee (Bucket-Handle Meniscus Tear)
* **Status:** True locked knee (unable to extend) is a relative orthopaedic urgency.
* **Action:** NWB on crutches, analgesia.
* **Referral:** Urgent HA Orthopaedic SOPD / Ward admission for prompt arthroscopy to unlock the joint and repair/resect the meniscus. Do NOT force knee into extension.
...
### Post-Op ACLR Rehabilitation Protocol (HA Guidelines)
* **Phase 1 (0-2 weeks):** 
	* Full extension (prevent cyclops lesion).
	* Early weight-bearing (usually FWB with brace locked in extension).
	* Quadriceps activation (straight leg raises).
* **Phase 2 (2-6 weeks):** 
	* Regain full ROM (especially flexion).
	* Closed kinetic chain exercises (mini-squats, leg press). Avoid open kinetic chain extension (strains graft).
* **Phase 3 (6-12 weeks):** 
	* Proprioception training, light jogging.
* **Phase 4 (6-9 months):** 
	* Return to sports criteria: Quadriceps strength >90% of contralateral leg, no effusion, pass hop tests.

### Post-Op Meniscal Repair Rehabilitation Protocol
* **Weight Bearing:** PWB or NWB for 4-6 weeks (protects sutures).
* **ROM:** Brace locked in extension for walking. Limited knee flexion (usually restricted to <90°) for first 4-6 weeks to prevent shear forces on the repair.
* **Note:** Contrast with partial meniscectomy, which allows immediate FWB and full ROM.


## 9. Orthopaedic Complications

### ACL Reconstruction Complications
* **Arthrofibrosis (Stiffness):** Most common complication if operated too early (acute inflamed phase) or delayed rehab. 

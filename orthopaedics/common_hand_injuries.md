...
### Flexor & Extensor Tendon Injury Clinical Definition & MOI
* **Definition:** Disruption of flexor/extensor mechanism → loss of active digit movement
* **Epidemiology:** Young working adults, manual laborers
...
* **Epidemiology:** Adult males, punch injuries
* **MOI:** Axial loading to partially flexed thumb metacarpal (e.g., fist fight)

## 2. Applied Orthopaedic Anatomy & Biomechanics

### Scaphoid Bone Vascular Anatomy & Biomechanics
...
### Flexor Tendon Laceration Clinical Assessment
* **Look:** Resting digit posture → loss of normal physiological cascade (injured digit remains extended)
* **Feel:** Tenderness along flexor sheath, palpable tendon gap
...
* **Feel:** +ve Anatomical snuffbox tenderness (high sensitivity)
...
| **II** | Middle Phalanx | Laceration |
| **III** | PIP Joint | Boutonnière Deformity |
| **IV** | Proximal Phalanx | Laceration |
...
### Scaphoid Fracture Radiological Investigations
* **Standard Scaphoid Series (4 views):**
  * AP view
  * Lateral view
  * PA view with ulnar deviation (stretches scaphoid out to true profile)
...
* **Traction X-ray:** Assesses comminution in Rolando #
...
### Tendon Laceration Initial ED Management
* **Wound Care:** Thorough saline washout
* **Bleeding Control:** Direct pressure, strict elevation (Avoid blind clamping → damages NV bundle)
...
### Flexor Tendon Definitive Management Algorithm
| Injury Type | Definitive Management |
| :--- | :--- |
| **Clean Cut (Zone I-V)** | Primary surgical repair in OT within 7-10 days |
| **Crush / Dirty Wound** | Delayed primary repair (after wound optimization) |
...
### Flexor Tendon Rehabilitation Protocol (HK HA Guidelines)
...
* **Protocol Rule:** Absolute ZERO flexion allowed during splint removal/washing. If DIP flexes, the 6-week clock restarts.
* **Weaning:** Night splinting for further 2-4 weeks.

### Scaphoid Fracture Rehabilitation Protocol
* **Cast Duration:** 6-8 weeks minimum, progressing to 12 weeks depending on zone
* **Follow-up:** Serial X-rays to assess union. CT scan prior to returning to contact sports.

## 9. Orthopaedic Complications

### Flexor Tendon Surgery Complications
* **Tendon Adhesion:** Most common, especially in Zone II. Requires tenolysis if unresponsive to physiotherapy.
* **Tendon Rupture:** Usually occurs days 7-14 when repair is at its weakest.
* **Joint Contracture:** PIPJ flexion contracture.

### Scaphoid Fracture Complications
* **Avascular Necrosis (AVN):** Especially proximal pole # (up to 100% if displaced). X-ray shows sclerosis.
* **Non-Union:** Fibrous or pseudarthrosis.
* **SNAC Wrist (Scaphoid Non-union Advanced Collapse):** Progressive radiocarpal osteoarthritis 2° to altered kinematics from non-union. Requires salvage procedures (e.g., 4-corner fusion, proximal row carpectomy).

### Base of Thumb Fractures Complications
* **1st CMCJ Osteoarthritis:** Secondary to articular step-off → causes pain, weakness in pinch grip.
* **Pin Tract Infection:** If managed with CRPP.

## 10. Examiner's Pearls

* Viva Question: What is the most crucial blood vessel in scaphoid vitality and where does it enter? Answer: Dorsal carpal branch of the radial artery, entering distally and flowing retrogradely to the proximal pole.
* Viva Question: A patient cuts his index finger palm side. He can flex the DIP joint, but not the PIP joint independently. What is injured? Answer: Isolated FDS laceration. FDP is intact.
* Trap: Assuming a normal initial X-ray rules out a scaphoid fracture in a patient with a FOOSH injury and snuffbox tenderness. Pearl: Up to 15% of acute scaphoid fractures are radiographically occult. Always immobilize in a thumb spica backslab and repeat X-ray in 10-14 days or order an MRI.
* Pitfall: Removing the mallet finger stack splint to wash the finger and letting the DIP joint droop. The healing tendon callus stretches instantly. Advise patients to keep the finger pressed flat against a table while changing the splint; if it drops, the 6-8 week treatment timeline resets to day zero.
* Trap: Using strong grip strength exercises in the first 6 weeks post flexor tendon repair to "prevent stiffness". Pearl: Active strong flexion during the initial healing phase will rupture the surgical repair (weakest at weeks 1-2). Strictly adhere to Kleinert/Duran controlled protocols.